...
> El módulo interno `whatsapp_turismo_bot/` quedó como variante legacy **deshabilitada** (`installable=False`) para forzar operación en **un solo módulo**: `tourism_provider_portal`.
